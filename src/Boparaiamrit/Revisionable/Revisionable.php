<?php namespace Boparaiamrit\Revisionable;
 ...
 */
class Revisionable extends Model
{
    /**
     * @var
     */
    ...
    {
        return $this->morphMany('\Boparaiamrit\Revisionable\Revision', 'revisionable');
    }
    ...
    public function postSave()
    {
        ...
        if ((!isset($this->revisionEnabled) || $this->revisionEnabled) && $this->updating) {
            ...
            if (count($revisions) > 0) {
                ...
                app('db')->collection($revision->getTable())->insert($revisions);
            }
        }
    }
